...
from .loss import ClipLoss, DistillClipLoss, CoCaLoss, SigLipLoss, HardNegativeLoss, ContrastiveLoss, NTXentLoss, TripletLoss
...
def create_loss(args):
    if args.distill:
        ...
        return ContrastiveLoss(
            temperature=args.temperature_contrastive,
            use_hard_negatives=args.use_hard_negatives,
            margin=args.margin_contrastive,
            local_loss=args.local_loss,
            gather_with_grad=args.gather_with_grad,
            cache_labels=True,
            rank=args.rank,
    ...
    elif args.ntxent_loss:
        return NTXentLoss(
            temperature=args.temperature_ntxent,
            normalize=args.normalize_ntxent,
            local_loss=args.local_loss,
            gather_with_grad=args.gather_with_grad,
            cache_labels=True,
            rank=args.rank,
        ...
        return TripletLoss(
            margin=args.margin_triplet,
            distance=args.distance_triplet,
            local_loss=args.local_loss,
            gather_with_grad=args.gather_with_grad,
            cache_labels=True,
            rank=args.rank,
