...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Use standard contrastive loss for training.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.1,
        help="Margin for hard negative mining in contrastive loss.",
    )
    parser.add_argument(
        "--ntxent-loss",
        default=False,
        action="store_true",
        help="Use NT-Xent loss for training.",
    )
    parser.add_argument(
        "--temperature-ntxent",
        type=float,
    ...
    parser.add_argument(
        ...
        default=True,
        action="store_true",
        help="Normalize features for NT-Xent loss.",
    )
    parser.add_argument(
        "--triplet-loss",
        default=False,
